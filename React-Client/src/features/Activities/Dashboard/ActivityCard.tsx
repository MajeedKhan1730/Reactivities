...
export default function ActivityCard({dataactivity,selectActivity,deleteActivity}:Props) {
  return (
    <Card sx={{borderRadius:3}}>
      ...
      <CardActions sx={{display:'flex', justifyContent:'space-between', pb:2}}>
        ...
        <Box display='flex' gap={2}>
            <Button onClick={() => selectActivity(dataactivity.id)} size ="medium"
             variant="contained" >View</Button>
             <Button onClick={() => deleteActivity(dataactivity.id)} color="error" size ="medium"
